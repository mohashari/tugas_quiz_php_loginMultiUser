...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input class="form-control" type="text" name="nama" id="" value="<?php print $row[1];?>" readonly>
    </div>
</div>
<div class="form-group">
    <label class="label-control col-sm-2">TEMPAT LAHIR</label>
    <div class="col-sm-7">
        <input class="form-control" type="text" name="tmp_lahir" id="" value="<?php print $row[2];?>" readonly>
    </div>
</div>
<div class="form-group">
    <label class="label-control col-sm-2">TGL LAHIR</label>
    <div class="col-sm-7">
        <input class="form-control" type="date" name="tgl_lahir" id="" value="<?php print $row[3];?>" readonly>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <textarea class="form-control" rows="4" name="alamat" id=""  readonly><?php print $row[5];?></textarea>
    </div>
</div>
<div class="form-group">
    <label class="label-control col-sm-2">TELEPON</label>
    <div class="col-sm-7">
        <input class="form-group" type="number" name="telepon" id="" value="<?php print $row[6];?>" readonly>
    </div>
    </div>
<div class="form-group">
        <button type="submit" class="btn btn-sm btn-warning" name="submit" id="" value="delete" >DELETE</button>
